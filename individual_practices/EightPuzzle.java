...
public class JogoDosOito {
        ...
        do {
            ...
            switch (choice){
                ...
                case 5:
                    ...
                    break;
                case 6:
                    System.out.println("aqui vem uma solução completa da inteligência BFS com dados legais");
                    break;
                case 7:
                    System.exit(200);
                    break;
    ...
    public static void printTable(List<Integer> list) {
        for (int i = 0; i < list.size(); i++){
            ...
            if (list.get(i) == 0) {
                System.out.print("_ "); // Imprime o sublinhado para o espaço vazio

            } else {
                System.out.print(list.get(i) + " "); // Imprime o número seguido de espaço
            }
        }
        System.out.println();
        }
